...
class DenseLayer(BaseLayer):
    ...
    def compute_gradient(self):
        ...
        self.dw = np.dot(self._input_data.transpose(),self._output_error_gradient)

        self.db = np.sum(self._output_error_gradient)

        self._input_error_gradient = np.dot(self.w,self._output_error_gradient.transpose()).transpose()
